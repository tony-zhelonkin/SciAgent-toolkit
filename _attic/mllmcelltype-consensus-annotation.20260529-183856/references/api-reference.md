...
| `consensus_proportion` | `{cluster: float 0–1}` | Fraction of models agreeing on the final label |
| `entropy` | `{cluster: float}` | Shannon entropy of model votes (higher = more disagreement) |
