...
> set size inline. The vendored `01_modules/RNAseq-toolkit/` is the only path
...
source("01_modules/RNAseq-toolkit/scripts/GSEA/GSEA_processing/parse_external_genesets.R")
