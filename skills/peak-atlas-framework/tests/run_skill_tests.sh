#!/usr/bin/env bash
# Run the peak-atlas-framework test scaffolds under testthat.
#
...
# are SCAFFOLDS — they currently report as skipped (via skip_scaffold()) until
# their fixtures are implemented in an R + Bioconductor env. See tests/README.md.
set -euo pipefail
