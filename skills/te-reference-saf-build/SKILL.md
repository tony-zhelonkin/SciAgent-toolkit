...
mechanical format conversion. The full theory lives in **TE-RNAseq-toolkit v2.0.0 —
...
- **Methodology / rationale** (subfamily vs locus, exon subtraction, Random-One, class composition): TE-RNAseq-toolkit **v2.0.0** — `docs/METHODOLOGY.md` (version-pinned; pointed to, not copied).
