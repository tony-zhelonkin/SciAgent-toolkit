---
name: scvi-framework
description: "scvi-tools framework foundation — installation, model selection decision tree, and shared setup_anndata / train / get_latent_representation patterns across all scvi-tools models. Use first when choosing between scVI variants (scVI, scANVI, MrVI, MultiVI, PeakVI, LinearSCVI, AmortizedLDA, contrastiveVI) or setting up a new scvi-tools environment. For the specific model implementation, use the corresponding scvi-* skill."
license: MIT
metadata:
