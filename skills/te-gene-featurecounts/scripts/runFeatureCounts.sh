...
# runFeatureCounts.sh
#
# VENDORED into the te-gene-featurecounts packaged skill (frozen copy; code
# identical to the toolkit original). Gene counting pass, invoked by
# runFeatureCounts_TE_and_genes.sh via "$(dirname "$0")/runFeatureCounts.sh".
# Run inside the locked container te-fc:2.0.2 (featureCounts/subread 2.0.2).
#
# Description:
